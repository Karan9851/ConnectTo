...
function VideoConnect() {
  ...
  useEffect(() => {
    if (roomId) {
      joinRoom(); // Automatically join the room when the component loads
    }
  }, [roomId]);
...
<div className={styles.lobbycontainer}>
  <div className={styles.glassPanel}>
    <h2 className={styles.heading}>Enter Your name to Connect</h2>
  ...
  <div className={styles.videocontainer}>
    <video className={styles.videopreview} ref={localVideoref} autoPlay muted />
        ...
        <div className={styles.connectVideoContainer}>
          {showModel ? (
...
<div className={videos.length === 1 ? styles.conferenceViewFull : styles.conferenceView}>
  {videos.map((video) => (
    <div key={video.socketId} className={styles.videoContainer}>
      ...
      {/* Video element */}
      <video className={styles.flipVideo}
